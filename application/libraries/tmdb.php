...
class TmDB
{
  ...
  {
    $url = "https://api.themoviedb.org/3/discover/movie?api_key=ec22337157b689e5a4a97da6b1ac5523";
  ...
  {
     $url =  "https://api.themoviedb.org/3/movie/ $id /videos?api_key=ec22337157b689e5a4a97da6b1ac5523";
    // Default language
    $response = file_get_contents($url);
  ...
  public function watch_provider_movie($id)
  {
    $url =  "https://api.themoviedb.org/3/movie/ $id /watch/providers?api_key=ec22337157b689e5a4a97da6b1ac5523";
    // Default language
    $response = file_get_contents($url);
  ...
  {
     $url =  "https://api.themoviedb.org/3/tv/ $id /videos?api_key=ec22337157b689e5a4a97da6b1ac5523";
    // Default language
    $response = file_get_contents($url);
